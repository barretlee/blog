...
> 要知道很多软件（例如 ChatGPT/Claude 等）的注册和使用，不仅要求你的 IP 是非中国区的，还要求你注册时用于验证的手机号码也是非中国区的，如遇到这类问题，可参阅前文 [《接码平台与海外手机卡》](/blog/2023/09/13/non-chinese-phone-checkcode-and-uk-giffgaff) 进行操作。
